        ...
        <div className="container mx-auto px-4 py-6 flex justify-between items-center">
          ...
          <nav>
            <ul className="flex space-x-6">
              <li><a href="/" className="text-gray-600 hover:text-teal-600">Home</a></li>
              <li><a href="/categories" className="text-gray-600 hover:text-teal-600">Categories</a></li>
              <li><a href="/about" className="text-gray-600 hover:text-teal-600">About</a></li>
              <li><a href="/contact" className="text-gray-600 hover:text-teal-600">Contact</a></li>
            </ul>
          </nav>
        </div>
      </header>
